...
def getDetailInfo(soup):
    ...
    DetailInfo.append(str(soup.find(attrs={"id": "ctl00_page_Content_cljg_tb"}).get('value')))
...
if __name__ == "__main__":
    ...
    cur = conn.cursor()
    dir = 'D:\爬虫数据-医疗\爬虫数据-医疗-王伟伟\www-爬虫数据\爬虫原始数据\产后42天访视'
